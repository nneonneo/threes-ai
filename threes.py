...
def to_val(x):
    x = np.asarray(x)
    # integer powers to negative integers break as of python 3.5
    # Ref: https://github.com/numpy/numpy/issues/8917
    # Create a version of the array with no negative integers
